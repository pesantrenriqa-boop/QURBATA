...
def compile_css(tokens,out,book):
 # Do not re-impose the legacy five-column/ellipsis target strip here.
 # Composition v10 owns target geometry in composition-v5.css.
...
async def inspect(page,n):
 ...
 const triples=document.querySelector('.composition-v5-triples'),footer=document.querySelector('.footer');if(triples&&footer){const a=triples.getBoundingClientRect(),b=footer.getBoundingClientRect();if(a.bottom>b.top-t)add('CONTENT_FOOTER_COLLISION',triples,{triplesBottom:a.bottom,footerTop:b.top})}
 return issues}''',n)
