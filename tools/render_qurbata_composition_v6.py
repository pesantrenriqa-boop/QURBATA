...
async def inspect(page,n):
 # Grid scrollHeight is not a reliable failure signal for Arabic glyph line boxes.
 # Validate true geometry instead: page/major zones may not scroll, and every rendered
 # Arabic object must remain inside its assigned slot and every slot inside its grid.
