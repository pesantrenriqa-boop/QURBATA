#!/usr/bin/env python3
"""QURBATA header/footer prototype v5 — clean header, footer block line only, review only."""
...
async def render():
 OUT.mkdir(parents=True,exist_ok=True);font,src=kfgloader.discover_font(None,None,OUT);h=OUT/'QURBATA-HEADER-FOOTER-PROTOTYPE-V5-FOOTER-BLOCK.html';h.write_text(html_doc(font.resolve().as_uri()),encoding='utf-8');pdf=free_path(OUT/'QURBATA-HEADER-FOOTER-PROTOTYPE-V5-FOOTER-BLOCK.pdf');png=free_path(OUT/'QURBATA-HEADER-FOOTER-PROTOTYPE-V5-FOOTER-BLOCK.png')
 ...
 print('QURBATA_HEADER_FOOTER_PROTOTYPE_V5=PASS');print('PRODUCTION_PAGES_MODIFIED=NO');print('HEADER_LINES=NONE');print('FOOTER_BLOCK_LINE=GREEN_BLOCK_PLUS_THIN_GOLD_ACCENT');print('FOOTER_ARABIC_FONT=KFGQPC_UTHMAN_TAHA');print(f'FONT_SOURCE={src}');print(f'PDF={pdf.relative_to(ROOT)}')
