#!/usr/bin/env python3
"""QURBATA Jilid 2 P004 — cumulative transfer page.

P004 intentionally introduces NO new letter family. It consolidates P001-P003
before the next acquisition step. Every three-letter object remains a documented
meaningful Arabic lexeme and must stay inside the acquired boundary.
"""
...
p001.MICRO=MICRO
# Through P004 only these joining families are acquired: ب ت ث ج ح خ س ش.
...
async def render_p004(h:Path,out:Path,debug:bool):
    ...
    async with async_playwright() as pw:
        ...
        pdf=out/'QURBATA-JILID-2-P004-V1-KFGQPC-TRANSFER.pdf'
...
def main():
    ...
    transfer=sum(1 for r in lex if r['function']=='TRANSFER'); murojaah=sum(1 for r in lex if r['function']=='MUROJAAH')
    ...
    print('NEW_ACQUISITION_LETTERS=NONE');print('CUMULATIVE_LETTERS=ب|ت|ث|ج|ح|خ|س|ش|ا|د|ذ|ر|ز|و')
