...
async def render(h,out):
    pdf=free_path(out/'QURBATA-JILID-1-P001-PRODUCTION-CLEAN-V9.pdf');png=free_path(out/'QURBATA-JILID-1-P001-PRODUCTION-CLEAN-V9.png')
