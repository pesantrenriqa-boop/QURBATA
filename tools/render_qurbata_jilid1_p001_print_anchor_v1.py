...
def build(font_uri,objects):
    ...
    css=f'''@page{{size:A5;margin:0}}*{{box-sizing:border-box}}@font-face{{font-family:"{FONT_FAMILY}";src:url("{font_uri}") format("truetype");font-display:block}}html,body{{margin:0;padding:0;background:#fff}}.page{{width:148mm;height:210mm;padding:3.6mm 8mm 2.5mm;display:flex;flex-direction:column;overflow:hidden;font-family:Arial,sans-serif}}.header{{height:17mm;flex:0 0 17mm;display:grid;grid-template-columns:34mm 1fr 13mm;align-items:center}}.brand-logo{{width:32mm;height:17mm;object-fit:contain;justify-self:start}}.title{{text-align:center;color:#064d37;font-family:Georgia,"Times New Roman",serif;font-size:6.2pt;font-weight:700;letter-spacing:.16em;white-space:nowrap}}.page-number{{justify-self:end;width:12mm;background:#064d37;color:#fff;border-bottom:1mm solid #b98a2f;text-align:center;font-weight:700;padding:2.2mm 1mm 3mm;border-radius:0 0 3mm 3mm;font-size:12pt}}.presentation{{height:20mm;flex:0 0 20mm;display:flex;align-items:center;justify-content:center;gap:13mm;font-family:"{FONT_FAMILY}",serif;font-size:46pt;line-height:1.05;direction:rtl;font-feature-settings:'mark' 1,'mkmk' 1}}.practice-grid{{height:160mm;flex:0 0 160mm;display:grid;grid-template-rows:repeat(7,minmax(0,1fr));row-gap:3.2mm;padding:.8mm 0 1mm;overflow:visible}}.practice-row{{display:flex;direction:rtl;align-items:center;justify-content:center;min-height:0;width:100%;overflow:visible}}.row-l2{{gap:10mm}}.row-l3{{gap:11mm}}.practice{{display:flex;align-items:center;justify-content:center;flex:0 0 auto;font-family:"{FONT_FAMILY}",serif;font-size:40pt;line-height:1.02;white-space:nowrap;border:0!important;background:transparent!important;box-shadow:none!important;font-feature-settings:'mark' 1,'mkmk' 1;text-rendering:optimizeLegibility;overflow:visible}}.l2{{width:23mm}}.l3{{width:35mm}}.token-run{{display:inline-flex;direction:rtl;align-items:center;justify-content:center}}.l2 .token-run{{gap:2.8mm}}.l3 .token-run{{gap:2.4mm}}.letter-token{{display:inline-block;direction:rtl;unicode-bidi:isolate}}.footer{{height:10mm;flex:0 0 10mm;display:flex;justify-content:space-between;align-items:flex-end;padding-bottom:.5mm;color:#173a2d}}.footer-ar{{font-family:"{FONT_FAMILY}",serif;font-size:10.3pt;line-height:1;direction:rtl;font-feature-settings:'mark' 1,'mkmk' 1}}'''
...
async def render(h,out):
    pdf=out/'QURBATA-JILID-1-P001-PRODUCTION-CLEAN-V9.pdf';png=out/'QURBATA-JILID-1-P001-PRODUCTION-CLEAN-V9.png'
