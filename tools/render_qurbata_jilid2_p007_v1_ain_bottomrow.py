...
def main():
 ...
 rc=v22.main();print('JILID2_P007_RENDERER_V3_FORM_DRILL=PASS');print('ACQUISITION_LETTERS=ع|غ');print('PRACTICE_MODE=JOINING_FORM_DRILL');print(f'FORM_AIN_OBJECTS={ain}');print(f'FORM_GHAIN_OBJECTS={ghain}');print('TITLE_VISUAL_RIGHT_TO_LEFT=عَ←عَبَرَ|غَ←غَرَبَ');print('PREMATURE_MADD_OR_HAMZAH=0');print('FUTURE_LETTER_LEAKAGE=0');return rc
