...
ROOT=Path(__file__).resolve().parents[1]; BASE=ROOT/'tools/render_qurbata_jilid1_p006_clean_v1.py'
...
# First 23 historical 50:50 ladders are the rendered source. L24 remains archived source/orphan.
...
async def render(h,o):
 pdf=m.free(o/'QURBATA-JILID-1-P008-TA-ZA-CANDIDATE-V1-SAFEAREA.pdf');png=m.free(o/'QURBATA-JILID-1-P008-TA-ZA-CANDIDATE-V1-SAFEAREA.png')
