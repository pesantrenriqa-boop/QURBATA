...
core=[r['word'] for r in lex[:24]];enrich=ladder['E07']
main_items=['يس','ص','ق','ن','يس','ص','ق','ن'];review_numbers=['٠','١','٢','٣','٤','٥','٦','٧','٨','٩'];review_letters=['ب','ت','ث','ج','ح','خ','س','ش']
p001.MICRO=MICRO;p001.P001_ROWS=[core[i:i+4] for i in range(0,24,4)];p001.P001_BANNED_JOINING=set()
p001.P001_CSS+=r'''
...
.j2-grid{margin:0!important;min-height:0!important;row-gap:4.2mm!important}.j2-object{overflow:visible!important}.j2-glyph{font-size:28pt!important;line-height:1.30!important;padding:1.3mm .8mm 1.5mm!important;overflow:visible!important}
'''
...
def main():
 ...
 rc=v22.main();print('JILID2_P012_RENDERER_V2_CLEAN_SPACING=PASS');print('PAGE=12');print('ACQUISITION_LETTERS=ي');print('TITLE_VISUAL_RIGHT_TO_LEFT=يَ←يَبِسَ');print(f'CURRENT_YA_OBJECTS={current}');print('CORE_OBJECTS=24');print('CORE_ROWS=6');print('PRACTICE_FONT_PT=28');print('PRACTICE_LINE_HEIGHT=1.30');print('CORE_ROW_GAP_MM=4.2');print('LOWER_DIVIDER_LINES=REMOVED');print('BOTTOM_NEW_COMPETENCY=E07_AWAILUSSURAR_4');print('BOTTOM_MAIN_ITEMS=8_FULL_WIDTH');print('BOTTOM_REVIEW=NUMERALS_PLUS_UNVOWELLED_LETTERS');return rc
