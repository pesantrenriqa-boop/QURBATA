...
FOCUS={'طُ','ظُ','عُ','غُ'}
EX=['طُ بَ','ظُ بِ','عُ تَ','غُ تِ','طُ ثَ','ظُ ثِ','عُ جَ','غُ جِ','طُ حَ ظُ','ظُ خِ عُ','عُ دَ غُ','غُ ذِ طُ','طُ رَ ظُ','ظُ زِ عُ','عُ سَ غُ','غُ شِ طُ','طُ صَ ظُ','ظُ ضِ عُ','عُ فَ غُ','غُ قِ طُ','طُ كَ ظُ','ظُ لِ عُ','عُ مَ غُ']
...
async def render(h):
 pdf=OUT/'QURBATA-JILID-1-P041-DAMMAH-05-CANDIDATE-V1-COMPACT.pdf'
