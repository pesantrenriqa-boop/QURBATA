...
p001.P001_CSS+=r'''.presentation-object{font-size:34pt!important;direction:ltr!important;flex-direction:row-reverse!important;gap:1.7mm!important}.presentation-object .arabic-part{direction:rtl!important;line-height:1.15!important}.presentation-object .arrow{font-size:15pt!important}.j2-glyph{font-size:39pt!important}.j2-grid{grid-template-rows:repeat(8,minmax(0,1fr))!important}.p009-enrichment-row{grid-column:1/-1!important;grid-row:8!important;display:flex!important;flex-direction:column!important;align-items:center!important;justify-content:center!important;padding:.35mm 3mm .25mm!important;border-top:.28mm solid #111!important;box-sizing:border-box!important;background:#fff!important;text-align:center!important;overflow:hidden!important}.p009-enrichment-row .micro-label{font-family:Arial,sans-serif!important;font-size:5.8pt!important;font-weight:700!important;margin:0 0 .45mm!important}.p009-enrichment-row .awail-run{width:100%!important;display:flex!important;align-items:center!important;justify-content:space-evenly!important;font-family:'KFGQPC Uthman Taha Naskh','Amiri Quran','Amiri',serif!important;font-size:29pt!important;line-height:1!important;direction:rtl!important;unicode-bidi:isolate!important;white-space:nowrap!important;letter-spacing:0!important}.p009-enrichment-row .awail-item{display:inline-block!important;margin:0 1.1mm!important;flex:0 0 auto!important}'''
...
def main():
 ...
 rc=v22.main();print('JILID2_P009_RENDERER_V4_KAF_LAM_MIXED_VOWELS=PASS');print('ACQUISITION_LETTERS=ك|ل');print('PRACTICE_MODE=JOINING_FORM_DRILL');print('CORE_DRILL_LENGTH=3_LETTERS_ONLY');print(f'FORM_KAF_OBJECTS={kaf}');print(f'FORM_LAM_OBJECTS={lam}');print('SHORT_VOWELS=FATHAH|KASRAH|DAMMAH');print('TITLE_VISUAL_RIGHT_TO_LEFT=كَ←كُتِبَ|لَ←لَبِثَ');print('PREMATURE_MADD_OR_HAMZAH=0');print('PREMATURE_MARK_LEAKAGE=0');print('FUTURE_LETTER_LEAKAGE=0');print(f'BOTTOM_ROW_ENRICHMENT_STEP={enrich["StepCode"]}');print(f'BOTTOM_ROW_ENRICHMENT_CATEGORY={enrich["Category"]}');print(f'BOTTOM_ROW_ENRICHMENT_LABEL={enrich["Label"]}');print(f'BOTTOM_ROW_ITEM_COUNT={len(items)}');print('BOTTOM_ROW_FONT_SIZE_PT=29');print('BOTTOM_ROW_ROTATION=ENABLED');print('PDF_WRITE_POLICY=INCREMENTAL_LOCK_SAFE_01_99');return rc
