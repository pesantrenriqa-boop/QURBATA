...
async def render(h,out,debug):
 report=out/'LAYOUT-OVERFLOW-REPORT-J2-P006-V6.json';png=out/'png';png.mkdir(parents=True,exist_ok=True)
 async with async_playwright() as pw:
  ...
  await page.screenshot(path=str(png/'page-006-v6.png'),full_page=True);pdf=out/'QURBATA-JILID-2-P006-V6-TA-ZA-FORM-DRILL.pdf';await page.pdf(path=str(pdf),format='A5',print_background=True,margin={'top':'0','right':'0','bottom':'0','left':'0'});await b.close()
 return metrics,report,pdf,'DIRECT_P006_V6'
p001.render=render
def main():
