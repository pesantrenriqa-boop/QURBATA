...
async def _write_pdf(page,out:Path):
    ...
    for idx,p in enumerate(names):
        try:
            ...
            return p,('DIRECT_P006' if idx==0 else f'LOCK_FALLBACK_P006_{idx:02d}')
...
async def render_p006(h:Path,out:Path,debug:bool):
    ...
    async with async_playwright() as pw:
        ...
        await page.screenshot(path=str(png/'page-006-v1.png'),full_page=True)
...
def main():
    ...
    print('ENRICHMENT_LAYOUT=INDIVIDUAL_FIXED_WIDTH_GLYPHS');print('OUTPUT_DIR=dist/qurbata-print-ready/jilid-2/pages/P006')
    return rc
