...
DEFAULT_OUT=ROOT/'dist/jilid-2-p001-candidate-v15'
...
async def render(h,out,debug):
 ...
 async with async_playwright() as p:
  ...
  await page.screenshot(path=str(png/'page-001.png'),full_page=True);pdf=out/'QURBATA-JILID-2-P001-CANDIDATE-V10.pdf';await page.pdf(path=str(pdf),format='A5',print_background=True,margin={'top':'0','right':'0','bottom':'0','left':'0'});await browser.close()
...
def main():
 ...
 print('JILID2_P001_RENDERER_V10=PASS');print('PAGE=1');print('HARAKAT_FATHA_OFFSET_EM=0.27');print('HARAKAT_DAMMA_OFFSET_EM=0.31');print('HARAKAT_KASRA_OFFSET_EM=-0.17');print('ROW_GAP_MM=3.2');print('GLYPH_LINE_HEIGHT=1.12');print('VERTICAL_VALIDATION=INTER_ROW_COLLISION');print('PRACTICE_OBJECTS=26');print('COMPETENCY_LEAKAGE=0');print('LAYOUT_OVERFLOW=0');print(f'OVERFLOW_REPORT={report.relative_to(ROOT)}');print(f'PDF={pdf.relative_to(ROOT)}');return 0
