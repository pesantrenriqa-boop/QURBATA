...
DEFAULT_OUT=ROOT/'dist/jilid-2-p001-candidate-v17'

def read_csv(p):
    with p.open(encoding='utf-8-sig',newline='') as f:return list(csv.DictReader(f))

def arabic_html(s):
    # Keep base letters + combining marks in one shaping run. Splitting harakat into
    # independent spans disables Amiri Quran OpenType mark/mkmk attachment and was
    # the real source of the visible collisions.
