...
def doc(u):
 ...
 css=f'''@page{{size:A5;margin:0}}*{{box-sizing:border-box}}@font-face{{font-family:"{FONT}";src:url("{u}") format("truetype")}}html,body{{margin:0}}.page{{width:148mm;height:210mm;padding:3.6mm 8mm 2.5mm;display:flex;flex-direction:column;overflow:hidden}}.header{{height:17mm;position:relative;display:flex;align-items:center;justify-content:center}}.logo{{position:absolute;left:0;width:32mm;height:17mm}}.title{{color:#064d37;font:700 6.2pt Georgia;letter-spacing:.16em}}.pageno{{position:absolute;right:0;top:0;width:12mm;background:#064d37;color:white;border-bottom:1mm solid #b98a2f;text-align:center;font:700 12pt Arial;padding:2.2mm 1mm 3mm;border-radius:0 0 3mm 3mm}}.presentation{{height:14mm;display:flex;align-items:center;justify-content:center;color:#064d37;font:700 10.5pt Georgia;letter-spacing:.1em}}.grid{{height:131mm;flex:0 0 131mm;display:grid;grid-template-rows:repeat(8,1fr);row-gap:.7mm}}.row{{display:flex;direction:rtl;align-items:center;justify-content:center;gap:11mm}}.practice{{width:35mm;display:flex;justify-content:center;font:39pt/1 "{FONT}";white-space:nowrap}}.run{{display:inline-flex;direction:rtl;gap:2.4mm}}.name-strip{{height:20mm;flex:0 0 20mm;border-top:.35mm solid #b9b9b9;display:flex;align-items:center;justify-content:center;direction:rtl;gap:4.5mm;font:27pt/1 "{FONT}";white-space:nowrap;padding-top:2.1mm}}.safe{{height:6mm;flex:0 0 6mm}}.footer{{height:12mm;display:flex;justify-content:space-between;align-items:center;padding-bottom:2.2mm;color:#173a2d}}.ar{{font:10.3pt "{FONT}";direction:rtl}}'''
...
async def render(h):
 pdf=free(OUT/'QURBATA-JILID-1-P018-PENGAYAAN-3-HURUF-NAMA-HURUF-01-CANDIDATE-V3.pdf');png=free(OUT/'QURBATA-JILID-1-P018-PENGAYAAN-3-HURUF-NAMA-HURUF-01-CANDIDATE-V3.png')
