...
# Set these paths for your local production environment.
...
txt(619,485,'يَا صَدِيقِي',F(font_ar,67),(12,38,31),anchor='mm',direction='rtl',lang='ar')
txt(619,565,'Yā ṣadīqī - wahai temanku',F(font_reg,18),gray,anchor='mm')

rounded((88,655,1150,885),38)
txt(619,755,'يَا صَدِيقَتِي',F(font_ar,67),(12,38,31),anchor='mm',direction='rtl',lang='ar')
txt(619,835,'Yā ṣadīqatī - wahai teman perempuanku',F(font_reg,18),gray,anchor='mm')
...
img.save('BAHASA-ARAB-QURBATA-J1-P003-v1.1.png',quality=95)
img.save('BAHASA-ARAB-QURBATA-J1-P003-v1.1.pdf','PDF',resolution=150.0)
