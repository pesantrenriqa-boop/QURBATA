# QURBATA Jilid 1 — Tartil Content Master P021–P040

**Status:** WORKING v0.1 — PDF production paused  
**Authority inputs:** Master Curriculum v1.1 + Page Registers P021–P030 and P031–P040.

## Hard rules
- 24 groups/page on normal pages; P040 is checkpoint-special.
- Every 3-letter group claimed as a word must be a real Arabic word with its exact printed harakat.
- No random 3-letter generator and no “near-semantic” pseudo-word.
- Dhammah is introduced strictly by page: P021 بُ تُ ثُ جُ; P022 حُ خُ دُ ذُ; P023 رُ زُ سُ شُ; P024 صُ ضُ طُ ظُ; P025 عُ غُ فُ قُ; P026 كُ لُ مُ نُ; P027 هُ وُ يُ ءُ.
- Fathah/Kasrah remain cumulative.
- No connected letters, mad, tanwin, sukun, or shaddah as Tartil competencies.
- Detached ه remains a two-hole glyph gate.

## Dhammah semantic-bank strategy
Unlike Fathah/Kasrah, many valid Form-I perfect verbs have middle-radical dhammah (فَعُلَ). Quranic Corpus explicitly confirms examples such as **كَبُرَ** (“to be great”) and **حَسُنَ** (“to be good”). These are useful only from the page where the relevant dhammah-bearing letter is legal. Corpus existence never overrides QURBATA page legality.

## Page blueprint

### P021 — بُ تُ ثُ جُ
01–06: two large planting rows comparing old Kasrah → new Dhammah: بِ→بُ, تِ→تُ, ثِ→ثُ, جِ→جُ.  
07–24: use legal cumulative Fathah/Kasrah WORD plus only verified WORD containing Dhammah on ب/ت/ث/ج. Do not invent a فَعُلَ form merely to fill slots.

### P022 — حُ خُ دُ ذُ
01–06: planting/contrast drills.  
07–24: cumulative WORD + verified new Dhammah WORD only. Candidate discovery must be lexically checked before allocation.

### P023 — رُ زُ سُ شُ
01–06: planting/contrast drills.  
07–24: cumulative WORD + verified Dhammah words. **حَسُنَ** is Quran-confirmed but its dhammah is on س, therefore it becomes legal from P023.

### P024 — صُ ضُ طُ ظُ
01–06: planting/contrast drills.  
07–24: cumulative legal words + verified Dhammah words using only Dhammah letters through P024.

### P025 — عُ غُ فُ قُ
01–06: planting/contrast drills.  
07–24: cumulative legal words + verified Dhammah words through P025.
...
07–24: full cumulative three-harakat word bank after lexical verification. This page completes Dhammah.

### P028 — Dhammah reinforcement
No new harakat. 24 groups curated across Fathah–Kasrah–Dhammah, all 29 letter identities represented over the page/adjacent review sequence.

### P029 — cumulative 1
24 curated groups. Three-letter groups must be meaningful WORDs; remove the older register allowance for “nyaris bermakna” at content-master level because the newer semantic rule is stricter.

### P030 — cumulative 2
24 curated groups balancing all three harakat and cumulative letters since P001.

### P031–P033 — cumulative reinforcement
No new Tartil feature. Build three distinct 24-group sets with balanced Fathah/Kasrah/Dhammah and broad letter coverage. Do not merely recycle P028–P030 in identical order.

### P034–P035 — final cumulative practice
Prioritize meaningful 3-letter WORDs with exact vowel integrity. No mechanical harakat substitution.

### P036–P038 — evaluative reinforcement
Use controlled, non-random 24-group sets designed for coverage: early/middle/late alphabet identities + all three harakat.

### P039 — pre-checkpoint
Simulation page. 24 curated groups with proportional coverage of Fathah/Kasrah/Dhammah and the full legal inventory.

### P040 — final Jilid 1 checkpoint
Special layout, not a normal 24-group page:
1. 29 letter identities **without harakat** for name recognition.
2. Names/signs: **فَتْحَة — كَسْرَة — ضَمَّة**.
...
3. Compute first-legal page for every dhammah-bearing letter.
4. Produce exact 24-group allocations P021–P039.
5. Audit P027 detached هُ two-hole.
6. Audit P040 29-letter coverage.
7. Freeze only after every allocated 3-letter word has meaning/gloss and verification status.
...
## Exact allocation P028-P039 v0.7

**Status:** CONTENT ALLOCATION LOCKED; PDF production remains blocked pending final book-level audit.

All groups below are selected from the already approved Fathah/Kasrah bank plus the Quran-confirmed Dhammah anchors `كَبُرَ، حَسُنَ، ضَعُفَ`. No pseudo-word is introduced. Because the approved Dhammah lexical inventory is intentionally small, controlled repetition is used instead of manufacturing additional فَعُلَ forms.

### P028 — Dhammah reinforcement
01 `كَبُرَ` | 02 `حَسُنَ` | 03 `ضَعُفَ` | 04 `كَبُرَ` | 05 `حَسُنَ` | 06 `ضَعُفَ` | 07 `كَبُرَ` | 08 `حَسُنَ`
09 `تَبِعَ` | 10 `فَرِحَ` | 11 `شَرِبَ` | 12 `خَسِرَ` | 13 `رَحِمَ` | 14 `حَسِبَ` | 15 `قَبِلَ` | 16 `عَرِفَ`
17 `بَحَثَ` | 18 `دَرَسَ` | 19 `صَبَرَ` | 20 `ضَرَبَ` | 21 `عَبَدَ` | 22 `غَفَرَ` | 23 `فَتَحَ` | 24 `قَرَأَ`.

### P029 — cumulative three-harakat 1
...
### P030 — cumulative three-harakat 2
01 `غَفَرَ` | 02 `نَصَرَ` | 03 `وَجَدَ` | 04 `قَطَعَ` | 05 `رَفَعَ` | 06 `دَفَعَ` | 07 `فَرَضَ` | 08 `قَصَدَ`
09 `عَلِمَ` | 10 `عَمِلَ` | 11 `سَمِعَ` | 12 `شَهِدَ` | 13 `وَرِثَ` | 14 `حَفِظَ` | 15 `فَهِمَ` | 16 `نَدِمَ`
17 `ضَعُفَ` | 18 `حَسُنَ` | 19 `كَبُرَ` | 20 `ضَعُفَ` | 21 `حَسُنَ` | 22 `كَبُرَ` | 23 `ضَعُفَ` | 24 `حَسُنَ`.

### P031
01 `بَرَزَ` | 02 `حَرَثَ` | 03 `سَجَدَ` | 04 `حَرَسَ` | 05 `شَرَحَ` | 06 `شَرَبَ` | 07 `صَدَرَ` | 08 `ضَحَكَ`
09 `فَرِحَ` | 10 `رَحِمَ` | 11 `حَسِبَ` | 12 `غَضِبَ` | 13 `وَسِعَ` | 14 `عَلِمَ` | 15 `عَمِلَ` | 16 `سَمِعَ`
17 `كَبُرَ` | 18 `حَسُنَ` | 19 `ضَعُفَ` | 20 `كَبُرَ` | 21 `حَسُنَ` | 22 `ضَعُفَ` | 23 `كَبُرَ` | 24 `ضَعُفَ`.

### P032
01 `عَبَرَ` | 02 `عَثَرَ` | 03 `غَرَسَ` | 04 `غَرَفَ` | 05 `غَرَقَ` | 06 `فَقَدَ` | 07 `قَذَفَ` | 08 `قَرَعَ`
09 `شَهِدَ` | 10 `وَرِثَ` | 11 `حَفِظَ` | 12 `قَبِلَ` | 13 `عَرِفَ` | 14 `فَهِمَ` | 15 `نَدِمَ` | 16 `تَبِعَ`
17 `حَسُنَ` | 18 `كَبُرَ` | 19 `ضَعُفَ` | 20 `حَسُنَ` | 21 `كَبُرَ` | 22 `ضَعُفَ` | 23 `حَسُنَ` | 24 `كَبُرَ`.

### P033
01 `مَنَعَ` | 02 `نَزَلَ` | 03 `نَفَعَ` | 04 `نَفَرَ` | 05 `نَشَرَ` | 06 `مَسَحَ` | 07 `مَسَكَ` | 08 `مَلَأَ`
09 `خَسِرَ` | 10 `رَحِمَ` | 11 `حَسِبَ` | 12 `غَضِبَ` | 13 `وَسِعَ` | 14 `عَلِمَ` | 15 `عَمِلَ` | 16 `سَمِعَ`
17 `ضَعُفَ` | 18 `كَبُرَ` | 19 `حَسُنَ` | 20 `ضَعُفَ` | 21 `كَبُرَ` | 22 `حَسُنَ` | 23 `ضَعُفَ` | 24 `كَبُرَ`.

### P034
01 `هَلَكَ` | 02 `هَجَرَ` | 03 `هَدَمَ` | 04 `هَرَبَ` | 05 `وَجَدَ` | 06 `وَرَدَ` | 07 `وَزَنَ` | 08 `وَهَبَ`
09 `فَرِحَ` | 10 `شَرِبَ` | 11 `قَبِلَ` | 12 `عَرِفَ` | 13 `شَهِدَ` | 14 `وَرِثَ` | 15 `حَفِظَ` | 16 `فَهِمَ`
17 `كَبُرَ` | 18 `حَسُنَ` | 19 `ضَعُفَ` | 20 `كَبُرَ` | 21 `حَسُنَ` | 22 `ضَعُفَ` | 23 `كَبُرَ` | 24 `حَسُنَ`.

### P035
01 `بَسَطَ` | 02 `طَرَحَ` | 03 `طَرَدَ` | 04 `طَبَخَ` | 05 `طَبَعَ` | 06 `رَجَعَ` | 07 `عَرَضَ` | 08 `عَجَزَ`
09 `تَبِعَ` | 10 `خَسِرَ` | 11 `رَحِمَ` | 12 `حَسِبَ` | 13 `وَسِعَ` | 14 `عَلِمَ` | 15 `عَمِلَ` | 16 `نَدِمَ`
17 `ضَعُفَ` | 18 `حَسُنَ` | 19 `كَبُرَ` | 20 `ضَعُفَ` | 21 `حَسُنَ` | 22 `كَبُرَ` | 23 `ضَعُفَ` | 24 `حَسُنَ`.

### P036
01 `فَتَحَ` | 02 `قَرَأَ` | 03 `كَتَبَ` | 04 `نَصَرَ` | 05 `وَجَدَ` | 06 `عَبَدَ` | 07 `غَفَرَ` | 08 `صَبَرَ`
09 `عَلِمَ` | 10 `عَمِلَ` | 11 `سَمِعَ` | 12 `شَهِدَ` | 13 `وَرِثَ` | 14 `حَفِظَ` | 15 `قَبِلَ` | 16 `عَرِفَ`
17 `كَبُرَ` | 18 `حَسُنَ` | 19 `ضَعُفَ` | 20 `حَسُنَ` | 21 `كَبُرَ` | 22 `ضَعُفَ` | 23 `كَبُرَ` | 24 `حَسُنَ`.

### P037
01 `دَرَسَ` | 02 `ضَرَبَ` | 03 `قَطَعَ` | 04 `رَفَعَ` | 05 `دَفَعَ` | 06 `فَرَضَ` | 07 `قَصَدَ` | 08 `غَرَسَ`
09 `فَرِحَ` | 10 `شَرِبَ` | 11 `خَسِرَ` | 12 `رَحِمَ` | 13 `حَسِبَ` | 14 `غَضِبَ` | 15 `وَسِعَ` | 16 `فَهِمَ`
17 `ضَعُفَ` | 18 `كَبُرَ` | 19 `حَسُنَ` | 20 `كَبُرَ` | 21 `ضَعُفَ` | 22 `حَسُنَ` | 23 `ضَعُفَ` | 24 `كَبُرَ`.

### P038
01 `بَحَثَ` | 02 `سَجَدَ` | 03 `شَرَحَ` | 04 `ضَحَكَ` | 05 `عَبَرَ` | 06 `فَقَدَ` | 07 `نَزَلَ` | 08 `وَهَبَ`
09 `تَبِعَ` | 10 `شَهِدَ` | 11 `وَرِثَ` | 12 `حَفِظَ` | 13 `قَبِلَ` | 14 `عَرِفَ` | 15 `عَمِلَ` | 16 `سَمِعَ`
17 `حَسُنَ` | 18 `ضَعُفَ` | 19 `كَبُرَ` | 20 `ضَعُفَ` | 21 `حَسُنَ` | 22 `كَبُرَ` | 23 `حَسُنَ` | 24 `ضَعُفَ`.

### P039 — pre-checkpoint
01 `قَرَأَ` | 02 `كَتَبَ` | 03 `عَبَدَ` | 04 `غَفَرَ` | 05 `صَبَرَ` | 06 `نَصَرَ` | 07 `وَجَدَ` | 08 `فَتَحَ`
09 `عَلِمَ` | 10 `عَمِلَ` | 11 `سَمِعَ` | 12 `شَهِدَ` | 13 `وَرِثَ` | 14 `حَفِظَ` | 15 `عَرِفَ` | 16 `فَهِمَ`
17 `كَبُرَ` | 18 `حَسُنَ` | 19 `ضَعُفَ` | 20 `حَسُنَ` | 21 `ضَعُفَ` | 22 `كَبُرَ` | 23 `ضَعُفَ` | 24 `حَسُنَ`.

### Allocation audit v0.7
- P028-P039: 12 pages × 24 groups = **288 allocated groups**.
- No new 3-letter lexical form was invented in this allocation.
...
- Full lexical-source audit for inherited Fathah/Kasrah items: SUPERSEDED by the completed P001–P020 global lexical audit; authority is Content Master P001–P020 FROZEN v1.1 candidate.
...
1. renderer proof that detached `هَ / هِ / هُ / ه` is visually two-hole.

The inherited Fathah/Kasrah global lexical audit is now PASS under the P001–P020 v1.1 audit ledger.
...
## Cross-master reconciliation v1.0-rc1

Reconciled against:
- `QURBATA-J1-TARTIL-CONTENT-MASTER-P001-P020-FROZEN-v1.1.md`
- completed global lexical inventory P001–P020
- Page Registers P021–P040
- Dhammah exact-form evidence audit

Result:
- inherited Fathah/Kasrah authority: **P001–P020 v1.1**
- P021–P039 exact allocations: **PASS**
- P040 checkpoint inventory: **PASS**
- Dhammah anchors `كَبُرَ، حَسُنَ، ضَعُفَ`: **PASS**
- HOLD items in production allocation: **0**
- pseudo-word production items: **0**
- content-side detached-heh sentinels: **PASS**
- renderer visual detached-heh proof: **PENDING**

Status: **CONTENT READY / VISUAL GATE PENDING**. This is not a unified final freeze and does not authorize a production PDF.
