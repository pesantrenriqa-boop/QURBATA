...
| Bukti | Evidence-ID | Status |
|---|---|---|
| hasil ahli REV-HAF-QJ1-001 |  | NOT PROVIDED |
| salinan sumber master dan pemeriksaan karakter |  | NOT PROVIDED |
| keputusan qiraah, rasm, harakat, tajwid, waqaf-ibtida’ |  | NOT PROVIDED |
| model bacaan dan hak penggunaan |  | NOT PROVIDED |
| pembagian potongan talqin |  | NOT PROVIDED |
| review MAP-HAF-QJ1-001 |  | NOT PROVIDED |
| review RUB-HAF-QJ1-001 dan FRM-HAF-QJ1-001 |  | NOT PROVIDED |
...
Document Controller hanya boleh mengubah status objek menjadi `ACTIVE-DRAFT` untuk pilot apabila:
