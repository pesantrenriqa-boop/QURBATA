...
## 6. Microtext Tahap 1–3

### AR-TXT-000002 — Guru dan Alat Belajar

**Status:** CANDIDATE — GATE NOT RUN  
**Cycle-ID calon:** AR-CYC-000001  
**Paket gerbang:** BAT-ARB-005  
**Integration-Type:** GENERAL  
**Stage maksimum:** AR-STG-003

> هٰذَا مُعَلِّمٌ. هٰذَا كِتَابٌ. هٰذَا قَلَمٌ.

Arti: Ini guru laki-laki. Ini buku. Ini pena.

| Audit | Hasil |
|---|---|
| Lema | AR-LEX-000011, 000001, 000002 |
| Unsur fungsional | AR-FW-000001 |
| Struktur/pola | AR-GRM-000001; AR-PAT-000001 |
| Sentence-ID | AR-SEN-000009, 000001, 000002 |
| Kosa kata tersembunyi | NIHIL |
| Kutipan ayat/hadis | TIDAK |

## 7. Paragraf Tahap 4–6

### AR-TXT-000003 — Benda di Ruang Kelas

**Status:** CANDIDATE — GATE NOT RUN  
**Cycle-ID calon:** AR-CYC-000002  
**Paket gerbang:** BAT-ARB-006  
**Integration-Type:** GENERAL  
**Stage maksimum:** AR-STG-006
...
Arti: Ini ruang kelas yang bersih. Ini jendela yang terbuka. Buku itu berada di atas meja. Pena itu berada di atas buku. Ini buku milik pelajar.

| Audit | Hasil |
|---|---|
| Lema | AR-LEX-000017, 000027, 000020, 000030, 000001, 000031, 000002, 000013 |
| Unsur fungsional | AR-FW-000001, 000002, 000006 |
| Struktur/pola | AR-GRM-000005–000007; AR-PAT-000005–000007 |
| Sentence-ID | AR-SEN-000029, 000032–000034, 000039 |
| Murojaah tahap lama | هٰذَا، كِتَابٌ، قَلَمٌ، طَالِبٌ |
| Kosa kata tersembunyi | NIHIL |
| Kutipan ayat/hadis | TIDAK |

## 8. Urutan Pedagogis Pilot

| Urut belajar | Cycle-ID | Stage | Text-ID | Paket | Status |
|---:|---|---|---|---|---|
| 1 | AR-CYC-000001 | 1–3 | AR-TXT-000002 | BAT-ARB-005 | GATE NOT RUN |
...
|---|---:|---:|---|
| Teks integrasi Jilid 1 | mengikuti jumlah siklus yang lulus gerbang | 3 | PILOT—SEMUA GATE NOT RUN |
