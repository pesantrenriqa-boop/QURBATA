# QJ3-MASTER — Struktur Buku QURBATA Jilid 3
...
## 3. Prinsip Urutan Huruf dan Halaman

1. Kode halaman: `QJ3-P001`–`QJ3-P040`.
...
9. Pembacaan sukun menutup makhraj tanpa menambah fathah, kasrah, atau dhammah.
10. Evaluasi tetap merupakan halaman materi: berisi contoh baca paralel, tidak mengenalkan unsur baru.
11. Pada tahap frasa/tajwid, empat kotak dapat membentuk satu frasa atau potongan ayat, sesuai DEC-CUR-015.
12. Master Markdown/data menjadi sumber tunggal semua turunan; perubahan material memerlukan Decision-ID dan riwayat versi.
...
| 24 | QJ3-P024 | Lam sukun pada kata 4–6 huruf | 3 → 4/5/6 |
| 25 | QJ3-P025 | Evaluasi lam sukun dan murojaah mad | 3 → 4/5/6 |
| 26 | QJ3-P026 | Bentuk اَلْ pada posisi mulai baca | 3 → 4/5 |
...
| 34 | QJ3-P034 | Integrasi tanwin–mad–sukun–qamariyah | 3 → 4/5/6 |
| 35 | QJ3-P035 | Kata panjang, termasuk kandidat يَسْتَغْفِرُ | 3 → 5/6+ |
| 36 | QJ3-P036 | Transfer ke frasa bermakna | 3 → frasa |
...
## 5. Matriks Integrasi Setiap Halaman

Setiap QJ3-Pxxx wajib mempunyai:

- materi baca utama dan murojaah;
- minimal satu objek Bahasa Arab bermakna;
- kaitan Tahfidz pada objek yang sudah tervalidasi;
- hadis/akhlak atau NIDOM yang sesuai tingkat literasi;
- LO, KO, cek formatif, dan remedial mikro;
- whitelist, Source-ID, risiko salah baca, safeguarding, dan metadata reviewer.

Integrasi tidak boleh mengurangi jumlah halaman materi atau menggantikan latihan baca.

## 6. Keterlacakan Wajib

`QC-000 → RCP-QUR-001 → DEC-CUR-010/015/016 → QJ3-MASTER → QJ3-Pxxx → LO → KO → latihan/asesmen → Source-ID/Evidence-ID → Decision-ID`.

## 7. Gate Makro Jilid 3
...
| 8 | otorisasi dan turunan final | OPEN |
...
6. tanam integrasi Tahfidz, Bahasa Arab, hadis/akhlak, NIDOM, asesmen, dan remedial pada setiap halaman;
7. render buku peserta/guru, review ahli, pilot, revisi, dan otorisasi.

## 9. Blocker

- LO/KO, whitelist, Source-ID, rubrik, dan batas kesalahan belum lengkap;
- kandidat kata/frasa Qurani belum seluruhnya ditashih dan diberi Evidence-ID;
- urutan qamariyah serta daftar bentuk sukun eligible memerlukan review ahli;
- pemeriksa akademik, tajwid/qira'at, editorial, asesmen, dan safeguarding belum dicatat;
- pilot serta bukti retensi/transfer belum tersedia.
...
- Kenaikan tangga: P021 = 3/4 huruf; P022–P023 = 3/4/5 huruf; P024 = 3/4/5/6 dengan 8 kata enam huruf; P025 = 3/4/5/6 dengan 12 kata enam huruf.
- Komposisi batch hasil audit ulang: 32 kata tiga huruf + 48 kata empat huruf + 20 kata lima huruf + 20 kata enam huruf.
- Pola transfer intensif mencakup يَعْلَمُونَ dan bentuk sejenis; pola ini mengulang sukun terdahulu bersama mad wāw dan tidak salah diklasifikasikan sebagai fokus لْ.
