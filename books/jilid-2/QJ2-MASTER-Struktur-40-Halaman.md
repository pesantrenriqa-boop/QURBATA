...
**Pengendali:** QC-000, QCF-QUR-001, QCF-QUR-002, RCP-QUR-001  
**Prasyarat:** Mastery Gate QURBATA Jilid 1  
**Pemeriksa/Pengesah:** Menunggu  

## 1. Hasil Akhir Jilid

Setelah menyelesaikan Jilid 2, peserta ditargetkan mampu membaca bentuk huruf bersambung sederhana pada posisi awal, tengah, dan akhir; mengenali tiga tanwin; serta membedakan harakat pendek dari mad asli alif, ya, dan waw dalam kata dan potongan terkendali.

Target belum merupakan klaim efektivitas sebelum review ahli, pilot, Evidence-ID, dan otorisasi selesai.

## 2. Batas Materi

**Masuk Jilid 2:** bentuk sambung, tanwin, mad asli, pemisahan bunyi pendek–panjang, kata Arab/Qurani yang seluruh unsurnya telah sah.

**Belum masuk:** sukun sebagai fokus sistematis, qalqalah, tasydid, hukum nun/mim sakinah, mad far'i, waqaf–ibtida' formal, dan tajwid lanjutan.
...
7. Mad asli dibaca sesuai model ahli; harakat pendek tidak boleh dipanjangkan.
8. Setiap halaman memiliki tema akhlak, LO, KO, asesmen, risiko, serta sumber bukti.
9. Evaluasi tidak mengenalkan materi baru.
10. N+1, N+2, N+4, N+8 digunakan untuk murojaah.
11. Materi guru yang belum lulus whitelist tidak dicetak sebagai bacaan peserta.
12. PDF diturunkan dari sumber ini setelah data halaman stabil.
...
`QC-000 → RCP-QUR-001 → QJ2-MASTER → QJ2-Pxxx → LO → KO → latihan/asesmen → Evidence-ID → Decision-ID`.

Setiap halaman belum boleh disebut lengkap sampai memiliki outcome, prasyarat, whitelist, contoh nyata, Source-ID, LO/KO, asesmen, remedial, risiko, safeguarding, serta metadata reviewer.

## 6. Gate Makro Jilid 2

| No. | Gate | Status |
|---:|---|---|
| 1 | struktur 40 halaman | COMPLETE-DRAFT |
| 2 | progression dan dependency | COMPLETE-DRAFT |
| 3 | isi nyata 40 halaman | SOURCE-COMPLETE — 40/40 tersedia; 20 COMPLETE-DRAFT +20 STAGED-BLOCKED |
| 4 | audit otomatis | OPEN |
| 5 | review ahli/akademik/editorial | READY-FOR-DISTRIBUTION — REV-QJ2-ALL-001 |
| 6 | asesmen dan safeguarding | OPEN |
| 7 | pilot dan revisi | OPEN |
| 8 | otorisasi, PDF final, dan arsip | OPEN |

## 7. Urutan Produksi

1. tetapkan LO/KO QJ2-P001–P040;
2. bangun whitelist bentuk sambung, tanwin, dan mad;
3. pilih latihan nyata P001–P009;
4. audit bentuk yang tidak dapat menyambung;
5. bentuk asesmen P010;
6. lanjutkan batch P011–P020, P021–P030, dan P031–P040;
7. tanam Tahfidz, Bahasa Arab, dan hadis/akhlak;
8. render PDF peserta/guru;
9. review, pilot, revisi, dan otorisasi.

## 8. Blocker

- urutan rinci bentuk sambung dan contoh Qurani belum diverifikasi ahli;
- penempatan tanwin dan mad asli memerlukan whitelist ilmiah;
- materi Hafalan 1/2, Bahasa Arab 2, dan Akhlak/Hadis 2 belum disahkan;
...
- **QJ2-P021–P024 tersedia sebagai STAGED-BLOCKED** dan lulus AUD-QJ2-TAN-003; menunggu BLK-QJ2-ORTHO-001.
- **QJ2-P025–P030 tersedia sebagai STAGED-BLOCKED**. P026/P027/P029/P030 lulus AUD-QJ2-MAD-001; P025 dan P028 menunggu objek khusus.
- **QJ2-P031–P040 tersedia sebagai STAGED-BLOCKED** dan lulus AUD-QJ2-FINAL-001.
- Cakupan sumber Jilid 2: **40/40 halaman (100%)**; kesiapan cetak dan otorisasi belum 100%.
- REV-QJ2-ALL-001 dan REG-QJ2-BLK-001 menyiapkan review tujuh fungsi dan 15 Gate-Item; seluruh Evidence-ID/Decision-ID masih kosong.
...
|---|---|---|
| 0.23.0-id | 29 Juli 2026 | Menambah paket review ahli terpadu dan register 15 Gate-Item; review siap didistribusikan tetapi belum dijalankan |
| 0.22.0-id | 29 Juli 2026 | P031–P040 selesai sebagai staging; seluruh sumber Jilid 2 tersedia 40/40, terdiri dari 20 COMPLETE-DRAFT dan 20 STAGED-BLOCKED; audit final sumber lulus |
| 0.21.0-id | 29 Juli 2026 | Staging P025–P030 selesai; whitelist dan blocker mad dibuat; sumber Jilid 2 tersedia sampai P030, dengan 20 COMPLETE-DRAFT dan 10 STAGED-BLOCKED |
